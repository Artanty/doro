...
import { EventProps, EventPropsWithState, EVENT_PROPS_KEY, EventStateHook } from "@services/basic-event/basic-event.types"
...
import { EventToDuplicateReq } from "@services/transition-event/transition-event.api.types"
import { TransitionEventService } from "@services/transition-event/transition-event.service"
import { NextSuggestionsRes, NextCalculatedEvent } from "@services/transition-event/transition-event.types"
import { BASE_SCHEDULE_ID, DEFAULT_EVENT_STATE_HOOKS, DEFAULT_WORK_EVENT_LENGTH, EventProgress, eventTypes, INITIAL_VIEW_STATE } from "../../../../constants"
